...
BACK_COLOR = os.getenv('BACK_COLOR', 'yellow')  # Background color for the QR code
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/Venkatasaikumarkethala')
